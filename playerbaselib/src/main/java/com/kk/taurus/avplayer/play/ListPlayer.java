...
public class ListPlayer extends BSPlayer {
    ...
    private ListPlayer(Context context){
        super(context);
    }
    ...
    @Override
    protected RelationAssist onCreateRelationAssist(Context context) {
        RelationAssist assist = new RelationAssist(context.getApplicationContext());
    ...
    public static ListPlayer get(Context context){
        if(i==null){
            synchronized (ListPlayer.class){
                if(i==null){
                    i = new ListPlayer(context);
                }
            }
        }
        return i;
