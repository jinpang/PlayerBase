...
public class ShareAnimationPlayer {
    ...
    private ShareAnimationPlayer(Context context){
        mAppContext = context;
    ...
    public static ShareAnimationPlayer get(Context context){
        if(null==i){
            synchronized (ShareAnimationPlayer.class){
                if(null==i){
                    i = new ShareAnimationPlayer(context.getApplicationContext());
                }
            }
        }
        return i;
